...
// import api from "@/utils/api"; // Correct path using alias for src
...
//     try {
//       const response = await api.post("/receptionists/login", {
//         email,
//         password,
...
//               {formError && (
//                 <div className="my-4 p-3 bg-red-100 border border-red-300 text-red-800 rounded-lg text-center text-sm">
//                   {formError}
//                 </div>
//               )}
